 ...
 * @author devcruz
 */
@WebServlet(name = "commentServlet", urlPatterns = {"/dashboard/comments"})
public class commentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            JSONArray arr = comment.GetAllComments();
            request.setAttribute("comments", arr);
            
            RequestDispatcher dispatcher = request.getRequestDispatcher("/dashboard/comments.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (comment.deleteComment(Integer.valueOf(id)) > 0){
