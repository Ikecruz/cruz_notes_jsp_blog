...
public class storyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String post_id = request.getParameter("query_id");
        
        try {
            JSONObject GetSinglePost = post.GetSinglePost(post_id);
            request.setAttribute("post", GetSinglePost.toJSONString());
            
            int views = (int) GetSinglePost.get("views");
            
            if (post.UpdateViews(views, Integer.valueOf(post_id)) > 0){
